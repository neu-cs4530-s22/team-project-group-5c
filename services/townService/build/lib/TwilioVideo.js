...
var TwilioVideo = (function () {
    ...
    TwilioVideo.getInstance = function () {
        if (!TwilioVideo._instance) {
            (0, assert_1.default)(process.env.TWILIO_API_AUTH_TOKEN, 'Environmental variable TWILIO_API_AUTH_TOKEN must be set');
            (0, assert_1.default)(process.env.TWILIO_ACCOUNT_SID, 'Environmental variable TWILIO_ACCOUNT_SID must be set');
            (0, assert_1.default)(process.env.TWILIO_API_KEY_SID, 'Environmental variable TWILIO_API_KEY_SID must be set');
            (0, assert_1.default)(process.env.TWILIO_API_KEY_SECRET, 'Environmental variable TWILIO_API_KEY_SECRET must be set');
    ...
    TwilioVideo.prototype.getTokenForTown = function (coveyTownID, clientIdentity) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                token = new twilio_1.default.jwt.AccessToken(this._twilioAccountSid, this._twilioApiKeySID, this._twilioApiKeySecret, {
